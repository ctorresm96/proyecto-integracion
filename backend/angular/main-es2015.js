...
let AsistenciasComponent = class AsistenciasComponent {
    constructor(_asistenciaService) {
        this._asistenciaService = _asistenciaService;
        this.asistencias = [];
    }
    ngOnInit() {
        this._asistenciaService.listarEntradas().subscribe((result) => {
            this.asistencias = result.message;
            console.log(this.asistencias);
        });
    }
};
AsistenciasComponent.ctorParameters = () => [
...
let HomeComponent = class HomeComponent {
    ...
    registrarIngreso() {
        ...
        this._asistenciaService.registrarEntrada(this.codigo).subscribe((result) => {
            if (result.ok == false) {
                if (result.error == 406) {
...
let RelojComponent = class RelojComponent {
    constructor() { }
    ngOnInit() {
